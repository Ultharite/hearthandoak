  ...
  return (
    <div className={`bg ${background}`}>
      ...
      <main>
        ...
        <InView threshold="0.5" onChange={(inView) => {inView === true ? setBackground('dark') : setBackground('light')}}>
          {({ inView, ref, entry }) => {
            return (
...
<InView threshold="0.1" onChange={(inView) => {inView === true ? setBackground('light') : setBackground('dark')}}>
          {({ inView, ref, entry }) =>{ return (
